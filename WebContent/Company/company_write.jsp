...
<script>
	...
	function company_send() {
		...
		var con = confirm('공고를 등록하시겠습니까?');
		
		if (con == true) {
			company_frm.action = 'Company?cmd=company_write_pro';
			company_frm.submit();
		}else {
...
<body>
    ...
    <div class="memberForm-tbl-wrap">
        ...
        <form name="company_frm" method="POST" onsubmit="return false">
        	<input type="hidden" name="name" value="${companyinfo.name }">
        	<input type="hidden" name="email" value="${companyinfo.email }">
        	<input type="hidden" name="ceo" value="${companyinfo.ceo }">
            <table class="memberForm-tbl">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row"><label for="category"><img src="Company/Img/red_star_spot.png"> 업종</label></th>
                        <td>
                    ...
                    <tr>
                        <th scope="row"><label for="loc"><img src="Company/Img/red_star_spot.png"> 근무 지역</label></th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="input-price" type="text" name="capital" id="capital">
                            <br>
                            <small class="email-info-box">
                                * 만 엔 단위로 숫자만 입력해 주세요. 예) 1,000만 엔 = 1000
                            </small>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th scope="row"><label for="estyear"><img src="Company/Img/red_star_spot.png"> 설립연도</label></th>
                        <td>
                            <input class="input-price" type="text" name="estyear" id="estyear">
                            <br>
                            <small class="email-info-box">
                                * 숫자만 입력해 주세요. 예) 2020년 = 2020
                            </small>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th scope="row"><label for="salary"><img src="Company/Img/red_star_spot.png"> 연봉</label></th>
                        <td>
                            <input class="input-price" type="text" name="salary" id="salary">
                            <br>
                            <small class="email-info-box">
                                * 만 엔 단위로 입력해 주세요. 예) 300만 엔 = 300
                            </small>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th scope="row"><label for="employeenum"><img src="Company/Img/red_star_spot.png"> 사원수</label></th>
                        <td>
                            <input class="input-price" type="text" name="employeenum" id="employeenum">
                            <br>
                            <small class="email-info-box">
                                * 숫자만 입력해 주세요. 예) 10명 = 10
                            </small>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th scope="row"><label for="employtype"><img src="Company/Img/red_star_spot.png"> 고용 형태</label></th>
                        <td>
                    ...
                    <tr>
                        <th scope="row"><label for="edulv"><img src="Company/Img/red_star_spot.png"> 학력 제한</label></th>
                        <td>
                    ...
                    <tr>
                        <th scope="row"><label for="japaneselv"><img src="Company/Img/red_star_spot.png"> 일본어 능력</label></th>
                        <td>
                    ...
                    <tr>
                        <th scope="row"><label for="contents"><img src="Company/Img/red_star_spot.png"> 기업 소개</label></th>
                        <td>
                            <textarea class="txt-area" id="contents" name="intro"></textarea>
                            <br>
                            <small class="email-info-box">
                                * 만 엔 단위로 숫자만 입력해 주세요. 예) 천 만 엔 = 1,000
                            </small>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th scope="row"><label for="address"><img src="Company/Img/red_star_spot.png"> 주소</label></th>
                        <td>
                            <input class="input-addr" type="text" name="address" id="address">
                            <br>
                            <small class="email-info-box">
                                * 영어 주소를 입력해 주세요.
                            </small>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="join-btn-wrap">
                                <input class="join" type="button" value="등록" onclick="company_send()">
